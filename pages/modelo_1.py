...
col4.metric("Frequência Média", formatar_numero(freq_media, 1))
col5.metric("Recência Média (dias)", formatar_numero(recencia_media, 1))
...
st.markdown("**História de Negócio:** Como gerente financeiro, busco entender a contribuição de cada cluster para a receita total. Este gráfico nos permite identificar os grupos de clientes mais lucrativos, direcionando os investimentos de forma mais estratégica e otimizando o retorno sobre o marketing.")
